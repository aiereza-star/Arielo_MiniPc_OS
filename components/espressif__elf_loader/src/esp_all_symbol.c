...
extern int minipc_touch_read(int16_t *x, int16_t *y);
extern int minipc_http_get_text();
extern int minipc_browser_init;
extern int minipc_browser_load;
extern int minipc_browser_set_loading;
extern int minipc_browser_state;
extern int minipc_browser_status_text;
extern int minipc_browser_get_line;
...
ESP_ELFSYM_EXPORT(minipc_http_get_text),
ESP_ELFSYM_EXPORT(minipc_browser_init),
ESP_ELFSYM_EXPORT(minipc_browser_load),
ESP_ELFSYM_EXPORT(minipc_browser_set_loading),
ESP_ELFSYM_EXPORT(minipc_browser_state),
ESP_ELFSYM_EXPORT(minipc_browser_status_text),
ESP_ELFSYM_EXPORT(minipc_browser_get_line),
    ESP_ELFSYM_END
};
