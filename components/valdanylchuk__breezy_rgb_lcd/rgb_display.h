...
typedef enum {
    ...
    SM_VGA13H   = 0x13,   // VGA mode 13h: 320x200 @ 8bpp (256 colors), centered on 800x480
    SM_150P     = 0x80,   // Custom mode: 256x150 @ 8bpp (256 colors), centered on 800x480
    SM_400X240  = 0x81,   // Arielo/Waveshare mode: 400x240 @ 8bpp, perfect 2x fit on 800x480
} screen_mode_t;
...
// 05A GUI base: hardware mouse pointer overlay in LCD pixel coordinates.
// x/y are 0..799 / 0..479. Pass visible=0 to hide.
...
// 05B GUI base: top status bar overlay for text-mode desktop.
