...
const sense_errors_t sense_errors_lut[] = {
    ...
    {0x02, 0x04, 0x01, "NOT READY: becoming ready"},
    {0x06, 0x28, 0x00, "UNIT ATTENTION: not ready to ready change, medium may have changed"},
    {0x06, 0x29, 0x00, "UNIT ATTENTION: power on, reset, or bus device reset occurred"},
    {0x06, 0x2A, 0x00, "UNIT ATTENTION: parameters changed"},
