@echo off
REM ============================================================
REM buildelf.bat - Compila sysinfo.c como app ELF Arielo MiniPC OS
REM Basado en el chasis de Calculator / Notepad.
REM ============================================================
...
if errorlevel 1 (
    echo ERROR: fallo el strip. sysinfo.elf sin recortar puede seguir sirviendo.
    exit /b 1
)
