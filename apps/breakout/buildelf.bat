@echo off
REM ============================================================
REM buildelf.bat - Compila breakout.c como app ELF para Arielo MiniPC OS
...
if errorlevel 1 (
    echo ERROR: fallo el strip. breakout.elf sin recortar puede seguir sirviendo.
    exit /b 1
)

echo.
echo OK: generado breakout.xtensa.elf
