@echo off
REM ============================================================
REM buildelf.bat - Compila mini_paint.c como app ELF para Arielo MiniPC OS
...
if errorlevel 1 (
    echo ERROR: fallo el strip. mini_paint.elf sin recortar puede seguir sirviendo.
    exit /b 1
)

echo.
echo OK: generado mini_paint.xtensa.elf
